        ...
        <>
            ...
            <div className='info_book_container'>
                ...
                <div className='buttons_info_book'>
                    <Button handlerClick={handleAddCart}>Añadir al Carro</Button>
                    <FontAwesomeIcon className={`favorite_button ${book.isFavorite && 'favorite'}`} icon={book.isFavorite ? solidHeart : regularHeart} />
                </div>
